...
const Footer = () => {
  ...
  return (
    <EachUtils of={language == "en" ? LIST_FooterQuestion_EN : LIST_FooterQuestion_ID} render={(item, index) => (
        <footer className="w-full text-white bg-black border-t-8 border-stone-900 p-8">
            ...
            <ul className="grid sm:grid-cols-4 gap-4 py-8">
                <EachUtils of={language == "en" ? LIST_FOOTER_EN : LIST_FOOTER_ID} render={(item, index) => (
                    <li key={index}>
